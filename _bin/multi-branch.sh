...
# This file has the starting point to fix GitHub Issues #6 and #28. Currently, it does just #6, as specified in .travis.yml (branch: master).
...
if "$TRAVIS_COMMIT" = "true" && "$TRAVIS_PULL_REQUEST" = "false" ]; then
	then
		CONT="true";
else
